  ...
  <div style="background-color:black; font-color:white;" class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
      		<li><a href="http://localhost/logreg/index.html">Home</a></li>
       
      </ul>
            <ul class="nav navbar-nav navbar-right">
             <li><a href="http://localhost/logreg/backend/index.php">Sign In</a></li>
        <li><a href="http://localhost/logreg/backend/register.php">Sign Up</a></li>
          </ul>
    </div>
    </nav>
  </div>
